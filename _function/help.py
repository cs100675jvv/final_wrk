def print_help():
    commands = [
        ...
        ("change-birthday [name]", "Змынити день народження для контакта."),
        ...
        ("delete_note [name]", "Видалити нототок."),
        ("show_note [name]", "Показати нотаток."),
        ("edit_note [name]", "Редагувати нотаток."),
        ("list-notes [name]", "Показати список всіх нотаток."),
